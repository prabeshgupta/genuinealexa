...
# Perplexity model - you can choose from: sonar, sonar-pro, sonar-reasoning
model = "sonar"
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "What do you want to know?"
...
class GptQueryIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        response_data = generate_perplexity_response(session_attr["chat_history"], processed_query, is_followup)
...
class CancelOrStopIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Good bye. Feel free to come back anytime"
...
def generate_perplexity_response(chat_history, new_question, is_followup=False):
    """Generates a Perplexity AI response to a question with enhanced context handling"""
    headers = {
        "Authorization": f"Bearer {api_key}",
        "Content-Type": "application/json"
    }
